    ...
    <h4>Sistem Penilaian</h4>
        <div class="container col-md-12;" style="display: flex; padding: 5vw 1vw 2vw 1vw">
            <div class="col-md-8">
                ...
                <form action="form belanja.php" method="POST" style="margin-top: 1vw; margin-left: 0.1vw;">
        ...
        <div class="container" style="padding: 2.5vw 1vw 2.5vw 1vw";>
            <table class="table table-bordered text-center">
                ...
                <?php require_once "proses belanja.php"; ?>
        ...
        <div class="text-center justify-content" style="padding: 1.5vw 1vw 1vw 1.5vw">
            <footer class="text-center" style="color: gray;">&copy Deva Lubna Listya STT-NF TI03 2023</footer>
        </div>
    </div>
</body>
</html>